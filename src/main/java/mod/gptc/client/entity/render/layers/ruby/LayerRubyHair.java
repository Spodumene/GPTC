...
public class LayerRubyHair extends FeatureRenderer<GemRuby, ModelRuby> {
	private static final Identifier HAIR = new Identifier("gptc:textures/entities/ruby/hair.png");

	public LayerRubyHair(FeatureRendererContext<GemRuby, ModelRuby> context) {
		super(context);
	...
	public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, GemRuby entity,
        ...
        VertexConsumer builder = vertexConsumers.getBuffer(RenderLayer.getEntityCutout(HAIR));
