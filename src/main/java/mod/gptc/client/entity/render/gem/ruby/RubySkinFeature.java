...
public class RubySkinFeature extends GeoLayerRenderer<GemRuby> {
	private static final Identifier SKIN = new Identifier("gptc:textures/entities/ruby/skin.png");
	float red;
	float green;
	float blue;
	public RubySkinFeature(IGeoRenderer<GemRuby> context) {
		super(context);
	}
	...
	public void render(MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int packedLightIn,
        ...
        int skin = entitylivingbaseIn.getSkinColor();
