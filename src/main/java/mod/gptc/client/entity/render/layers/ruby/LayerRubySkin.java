...
public class LayerRubySkin extends FeatureRenderer<GemRuby, ModelRuby> {
	private static final Identifier SKIN = new Identifier("gptc:textures/entities/ruby/skin.png");

	public LayerRubySkin(FeatureRendererContext<GemRuby, ModelRuby> context) {
		super(context);
	...
	public void render(MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, GemRuby entity,
        ...
        VertexConsumer builder = vertexConsumers.getBuffer(RenderLayer.getEntityCutout(SKIN));
